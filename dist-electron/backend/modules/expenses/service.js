...
exports.createExpensesService = void 0;
...
const createExpensesService = (db) => {
    ...
    const list = async () => {
        const rows = await db
            ...
            'e.created_by',
            'e.created_at',
            (0, kysely_1.sql) `c.name`.as('category_name') // 🔥 ESTE ES EL IMPORTANTE
        ])
            .orderBy('e.id desc')
            .execute();
...
exports.createExpensesService = createExpensesService;
