      ...
      <div className="card-panel stack-gap">
        ...
        <div className="detail-grid">
          <div className="card-panel stack-gap">
            ...
            <div className="detail-row">
              <span>Estado</span>
              <strong>{selectedOrder?.statusName || '—'}</strong>
            </div>
          </div>
          ...
          <div className="card-panel stack-gap">
            ...
            <div className="detail-row">
              <span>Total</span>
              <strong>{selectedOrder ? currency(selectedOrder.total) : '—'}</strong>
            </div>
            <div className="detail-row">
              <span>Abonado</span>
              <strong>{selectedOrder ? currency(selectedOrder.paidTotal) : '—'}</strong>
            </div>
            <div className="detail-row">
              <span>Saldo</span>
              <strong>{selectedOrder ? currency(selectedOrder.balanceDue) : '—'}</strong>
            </div>
            <div className="detail-row">
              <span>Fecha promesa</span>
              <strong>{selectedOrder?.dueDate ? dateTime(selectedOrder.dueDate) : '—'}</strong>
            </div>
          </div>
        </div>
